      ...
      <div id="main-wrapper">
        <div class="site-wrapper-reveal">
          ...
          <div class="banner-area-box">
            <div class="container">
              <div class="row banner-inner-box" style={{ zIndex: 9 }}>
            ...
            <div class="container">
              ...
              <div class="tab-content mt-30">
                <div class="tab-pane fade show active" id="tab_list_01">
                  ...
                  <div class="product-slider-active" style={{ position: "relative" }}>
                    <Swiper
                      modules={[Navigation]}
                      loop
                      slidesPerView={4}
                    ...
                    <i ref={navigationPrevRef} class="icon-arrow-left arrow-prv slick-arrow"></i>
                    <i ref={navigationNextRef} class="icon-arrow-right arrow-next slick-arrow"></i>
                  </div>
                </div>
                    ...
                    <div class="row">
                      <div class="col-lg-7 col-md-9">
                        <div class="colection-info-wrap">
                          ...
                          <div class="button-box section-space--mt_60">
                            <a href="shop-4-column.html" class="text-btn-normal font-weight--bold font-lg-p">Discover now <i class="icon-arrow-right"></i></a>
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          <div class="our-brand-area section-space--pb_90">
            <div class="container">
              <div class="brand-slider-active" style={{ position: "relative" }}>
                <Swiper
                  modules={[Navigation]}
                  loop
                  slidesPerView={5}
                ...
                <i ref={navigationPrevRef1} class=" icon-arrow-left arrow-prv slick-arrow"></i>
                <i ref={navigationNextRef2} class=" icon-arrow-right arrow-next slick-arrow"></i>
              </div>
            </div>
          </div>
          {/* <!-- Our Brand Area End --> */}
